...
import { selectCatalogs, selectTitleFromEpisodeDc } from "../redux/metadataSlice";
...
const VideoHeader: React.FC<{}> = () => {
  ...
  return (
    <div title={t("video.area-tooltip")} css={{fontSize: '16px'}}>
      <div css={[titleStyle, titleStyleBold]} title={t("video.title-tooltip")}>{metadataTitle}</div>
      {presenter_header}
    </div>
  );
}
